...
class LeftNavMap:
    ...
    def settings_user_maintenance_link(self):
        '''Location of the SETTINGS > USER MAINTENANCE link
        in the navigation bar'''
    ...
    def settings_billing_charges_link(self):
        '''Location of the SETTINGS > BILLING CHARGGES link
        in the navigation bar'''
